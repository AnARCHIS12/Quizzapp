...
INSERT IGNORE INTO `achievements` (`id`, `name`, `description`, `badge_image`, `criteria_type`, `criteria_value`) VALUES
...
INSERT IGNORE INTO `categories` (`id`, `parent_id`, `name`, `slug`, `description`, `image_url`) VALUES
...
INSERT IGNORE INTO `users` (`id`, `username`, `email`, `password_hash`, `avatar_url`, `role_id`, `email_verified`) VALUES
...
INSERT IGNORE INTO `user_statistics` (`user_id`, `level`, `xp`, `total_played`, `correct_count`, `time_spent`, `average_time_per_question`) VALUES
(1, 1, 0, 0, 0, 0, 0),
(2, 1, 0, 0, 0, 0, 0);

-- 5. Seed Quizzes
INSERT IGNORE INTO `quizzes` (`id`, `category_id`, `title`, `description`, `time_limit`, `xp_reward`) VALUES
